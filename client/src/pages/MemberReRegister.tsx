...
export default function MemberReRegister() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const memoFinal = form.isServiceSession
    ...
    updateMutation.mutate({
      ...
      ptProgram: form.isServiceSession ? "서비스세션" : (form.ptProgram || undefined),
      ptSessions: form.ptSessions ? parseInt(form.ptSessions) as any : undefined,
      paymentAmount: form.isServiceSession ? 0 : (form.paymentAmount ? parseInt(form.paymentAmount) : undefined),
    ...
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={e => {
                    ...
                    setForm(p => ({ ...p, membershipStart: start, membershipEnd: calcEndDate(start, p.ptSessions) }));
                  }}
              ...
              <div className="space-y-1.5">
                ...
                <Input type="date" value={form.membershipEnd} readOnly className="bg-input border-border opacity-60 cursor-not-allowed" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  value={form.isServiceSession ? "0" : form.paymentAmount}
        ...
        <div className="flex gap-3 pb-4">
          ...
          <Button type="submit" className="flex-1" disabled={updateMutation.isPending || !selectedMemberId}>
