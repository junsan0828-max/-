...
export function GymPlusVideosAdmin() {
  ...
  function handleSubmit() {
    const data = { ...form, categoryId: form.categoryId ? parseInt(form.categoryId) : undefined, isPublished: parseInt(form.isPublished), sortOrder: parseInt(form.sortOrder) || 0 };
          ...
          <div key={e.id} className="flex items-center gap-3 bg-background/50 rounded-xl p-3">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5 mb-0.5">
                <span className="text-[10px] text-muted-foreground">{typeLabel[e.eventType] ?? e.eventType}</span>
