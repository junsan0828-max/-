...
async function initDatabase() {
  ...
  const alterStatements = [
    ...
    `ALTER TABLE gym_plus_videos ADD COLUMN IF NOT EXISTS "recommendedSets" INTEGER`,
    `ALTER TABLE gym_plus_videos ADD COLUMN IF NOT EXISTS "recommendedReps" TEXT`,
    `ALTER TABLE gym_plus_videos ADD COLUMN IF NOT EXISTS "restSeconds" INTEGER`,
    ...
    `ALTER TABLE gym_plus_membership_renewals ADD COLUMN IF NOT EXISTS "notes" TEXT`,
    `ALTER TABLE gym_plus_membership_renewals ADD COLUMN IF NOT EXISTS "agreedToTerms" INTEGER DEFAULT 0`,
    `ALTER TABLE gym_plus_membership_renewals ADD COLUMN IF NOT EXISTS "agreedPrivacy" INTEGER DEFAULT 0`,
    `ALTER TABLE gym_plus_membership_renewals ADD COLUMN IF NOT EXISTS "agreedMarketing" INTEGER DEFAULT 0`,
    `ALTER TABLE gym_plus_membership_renewals ADD COLUMN IF NOT EXISTS "trainerName" TEXT`,
    ...
    `CREATE TABLE IF NOT EXISTS gym_plus_point_extension_requests (
      id SERIAL PRIMARY KEY,
      "gymPlusMemberId" INTEGER NOT NULL,
