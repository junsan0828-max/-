...
export async function syncSheetNow(): Promise<{ newMembers: number; message: string }> {
  ...
  const AUTO_GUESS: Record<string, string> = {
    ...
    등급: "grade",
    상태: "status",
    시작일: "membershipStart", 등록일: "membershipStart", 가입일: "membershipStart", 회원권시작: "membershipStart", 운동시작일: "membershipStart",
    만료일: "membershipEnd", 종료일: "membershipEnd", 회원권만료: "membershipEnd", 운동종료일: "membershipEnd",
